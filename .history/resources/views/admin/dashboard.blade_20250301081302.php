...
<div class="content">
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card text-center shadow-lg rounded-lg border-0 hover-effect">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card bg-danger text-center shadow-lg rounded-lg border-0 hover-effect">
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h5>Revenue</h5>
                                <h3>$12,000</h3>
