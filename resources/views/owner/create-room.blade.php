...
@section('content')
    <div class="form-container">
        ...
        <form action="{{ route('room.store') }}" method="POST"  enctype="multipart/form-data">
            ...
            <input type="number" name="count" class="form-control" placeholder="Count" value="{{ old('count') }}"
                required>
            @error('count')
                <div class="custom-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
            @enderror

            <input type="number" name="size" class="form-control" placeholder="Size" value="{{ old('size') }}"
                required>
            @error('size')
                <div class="custom-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
            @enderror

            <input type="number" name="capacity" class="form-control" placeholder="Capicity" value="{{ old('capacity') }}"
                required>
            @error('capacity')
                <div class="custom-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
            @enderror
