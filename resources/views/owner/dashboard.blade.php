                    ...
                    <div class="col-md-3">
                        <div class="card custom-card text-white shadow-lg border-0 hover-effect">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-number">{{ $ownerRoomsCount }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card custom-card text-white shadow-lg border-0 hover-effect">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-number">{{ $ownerBookingsCount }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card custom-card text-white shadow-lg border-0 hover-effect">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-number">${{ number_format($ownerRevenue, 2) }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card custom-card text-white shadow-lg border-0 hover-effect">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-number">{{ $ownerReviewsCount }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
